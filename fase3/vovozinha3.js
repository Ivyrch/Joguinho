function escolher() {
    setTimeout(() => {
        var escolha= prompt("Estou um pouco apreensiva. Você tem certeza que fugir seria o melhor dos planos para uma idosa? \n digite: \n 1- sim, tenho certeza dessa decisão ou \n 2- não, é melhor voltar para casa e chamar ajuda!");
